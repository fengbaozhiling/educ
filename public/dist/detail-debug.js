define("educate/educate/1.0.0/detail-debug", [ "./base-debug", "./edstyle-debug", "./lang-debug", "./jquery.lazyload-debug", "./login-debug", "./dialog/1.0.0/dialog-plus-debug", "./dialog/1.0.0/dialog-debug", "./dialog/1.0.0/popup-debug", "./dialog/1.0.0/dialog-config-debug", "./dialog/1.0.0/drag-debug", "./formvalidat/1.0.0/form_and_validation-debug", "./ask-debug", "./rating/jquery.rating-debug", "./jquery.scrollbar-debug", "./jquery.masonry.min-debug", "./jquery.bgiframe-debug", "./swfobject-debug", "./comment-debug" ], function(require, exports, module) {
    var base = require("./base-debug");
    var edstyle = require("./edstyle-debug");
    var dialog = require("./dialog/1.0.0/dialog-plus-debug");
    var ask = require("./ask-debug");
    var rating = require("./rating/jquery.rating-debug");
    var scrollbar = require("./jquery.scrollbar-debug");
    var masonry = require("./jquery.masonry.min-debug");
    ...
    var flashvars = {
        resourceId: 24,
        siteUrl: "http://xt.epweike.com/",
        previewImg: "http://" + http_host + "public/images/img11.jpg"
    };
    var params = {
        menu: "false",
        wmode: "opaque",
...
define("educate/educate/1.0.0/ask-debug", [], function(require, exports, module) {
    ...
    (function($) {
        ...
        EDUCAT.AskAnswer = function(aid, btn) {
            ...
            EDUCAT.ShowMiniLoading(box);
            $.ajax({
                url: SITEURL + "ajax/ajax_answer.html",
                type: "get",
                data: query,
                cache: false,
                dataType: "html",
...
define("educate/educate/1.0.0/jquery.scrollbar-debug", [], function(require, exports, module) {
    return function(a) {
        a.tiny = a.tiny || {};
        a.tiny.scrollbar = {
            options: {
        ...
        function b(q, g) {
            ...
            function i(A) {
                a("body").addClass("no_scrollbar_select");
            ...
            function f() {
                a("body").removeClass("no_scrollbar_select");
...
define("educate/educate/1.0.0/jquery.masonry.min-debug", [], function(require) {
    /**
        ...
        b.fn.masonry = function(a) {
            if (typeof a == "string") {
                ...
                this.each(function() {
                    ...
                    if (!d) g("cannot call methods on masonry prior to initialization; attempted to call method '" + a + "'"); else {
...
define("educate/educate/1.0.0/comment-debug", [ "educate/educate/1.0.0/edstyle-debug", "educate/educate/1.0.0/base-debug", "educate/educate/1.0.0/lang-debug", "educate/educate/1.0.0/jquery.lazyload-debug", "educate/educate/1.0.0/login-debug", "educate/educate/1.0.0/dialog/1.0.0/dialog-plus-debug", "educate/educate/1.0.0/dialog/1.0.0/dialog-debug", "educate/educate/1.0.0/dialog/1.0.0/popup-debug", "educate/educate/1.0.0/dialog/1.0.0/dialog-config-debug", "educate/educate/1.0.0/dialog/1.0.0/drag-debug", "educate/educate/1.0.0/formvalidat/1.0.0/form_and_validation-debug" ], function(require, exports, module) {
