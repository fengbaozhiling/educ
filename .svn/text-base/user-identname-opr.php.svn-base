	...
	<div class="container">
		...
		<div class="usbox clfix">
			<div class="m-umain">
				...
				<div class="m-order">
					<div class="od clfix">
						<a href="">个人认证</a><a class="seleted" href="">企业认证</a>
					</div>
				</div>
				<div class="m-fostep">
					<div class="forgtstep clfix"><span class="crent">填写企业信息</span><span>等待审核通过</span></div>
				</div>
				<div class="m-form">
					<form name="mform">
					<div class="elmt">
					...
					<div class="elmt">
						<input class="tx" size="30" type="text" placeholder="企业名称" id="copname" name="copname" maxlength="60" msg="请输入企业名称" msgarea="copname_msg" limit="required:true;type:string"><span id="copname_msg"></span>
					</div>
					<div class="elmt">
						<input class="tx" size="30" type="text" placeholder="法人姓名" id="yourname" name="yourname" maxlength="60" msg="请输入法人姓名" msgarea="yourname_msg" limit="required:true;type:string"><span id="yourname_msg"></span>
					</div>
					<div class="elmt">
						<input class="tx" size="30" type="text" placeholder="营业执照编号" id="coplicence" name="coplicence" maxlength="60" msg="请输入营业执照编号" msgarea="coplicence_msg" limit="required:true;type:string"><span id="coplicence_msg"></span>
					</div>
					<div class="elmt">
						营业执照图片：<input type="file">
					</div>
